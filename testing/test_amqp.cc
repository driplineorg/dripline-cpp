...
TEST_CASE( "amqp_table", "[amqp]" )
{
    ...
    SECTION( "value" )
    {
        ...
        t_conv_table_value = dripline::param_to_table( t_value );
        REQUIRE( t_conv_table_value.GetType() == AmqpClient::TableValue::VT_uint32 );
        REQUIRE( t_conv_table_value.GetUint32() == t_value.as_uint() );
    ...
    SECTION( "node" )
    {
        ...
        REQUIRE( t_conv_table["value2"].GetUint32() == t_node["value2"]().as_uint() );
    ...
    SECTION( "array" )
    {
        ...
        REQUIRE( t_conv_array[2].GetUint32() == t_array[2]().as_uint() );
    ...
    SECTION( "nesting" )
    {
        ...
        REQUIRE( t_conv_table_value.GetTable()["value1"].GetType() == AmqpClient::TableValue::VT_uint32 );
        ...
        REQUIRE( t_conv_table_value.GetTable()["array1"].GetArray()[0].GetType() == AmqpClient::TableValue::VT_uint32 );
        ...
        REQUIRE( t_conv_table_value.GetTable()["array1"].GetArray()[1].GetArray()[0].GetType() == AmqpClient::TableValue::VT_uint32 );

        REQUIRE( t_conv_table_value.GetTable()["array1"].GetArray()[2].GetTable()["value3"].GetType() == AmqpClient::TableValue::VT_uint32 );
        
        REQUIRE( t_conv_table_value.GetTable()["node1"].GetTable()["value2"].GetType() == AmqpClient::TableValue::VT_uint32 );
        ...
        REQUIRE( t_conv_table_value.GetTable()["node1"].GetTable()["array2"].GetArray()[0].GetType() == AmqpClient::TableValue::VT_uint32 );

        REQUIRE( t_conv_table_value.GetTable()["node1"].GetTable()["node2"].GetTable()["value3"].GetType() == AmqpClient::TableValue::VT_uint32 );
