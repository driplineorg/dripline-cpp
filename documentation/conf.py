...
htmlhelp_basename = 'DriplineCppdoc'
...
man_pages = [
    (master_doc, 'dripline-cpp', u'Dripline-Cpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Dripline-Cpp', 'Dripline-Cpp Documentation',
   author, 'Dripline-Cpp', 'Dripline implementation in C++',
   'Miscellaneous'),
]
